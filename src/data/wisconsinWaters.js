...
export const bodiesOfWater = [
    ...
    spots: [
      {
        ...
        dogFriendly: true,
        seclusionScore: 'Moderate',
        dogFriendlyNote: 'Paved river trail, leash required',
        gaugeId: '04087000',
    ...
    spots: [
      {
        ...
        dogFriendly: true,
        seclusionScore: 'Low',
        dogFriendlyNote: 'Grassy campground banks, leash required',
      ...
      {
        id: 39,
        name: 'Rice Lake – Kettle Moraine',
        query: 'Rice Lake Kettle Moraine Southern Unit Eagle WI parking',
        fish: ['Largemouth Bass', 'Bluegill', 'Crappie', 'Yellow Perch'],
        difficulty: 'Easy',
        accessPoint: 'State forest trail from parking area (~0.35 mi)',
        dogFriendly: true,
        seclusionScore: 'High',
        dogFriendlyNote: 'Grassy/Sandy shore, leash required — very dog-friendly',
        notes: 'A quiet glacial lake tucked inside Kettle Moraine Southern Unit near Eagle, WI. Reached via a 0.35-mile trail through oak forest from the nearest DNR parking area — far enough to shed most casual visitors. Grassy and sandy shoreline makes for comfortable bank fishing. Excellent bluegill and crappie on a light panfish rig around the reed edges. Largemouth bass in the weedy shallows at dawn and dusk. Dogs on leash are welcome and the trail is excellent for a combined fishing/hiking outing. State park vehicle sticker required.',
        coords: { lat: 42.8620, lng: -88.4370 },
      },
...

  {
    ...
    spots: [
      ...
      },
      {
        ...
        dogFriendly: true,
        seclusionScore: 'High',
        dogFriendlyNote: 'Rocky/Dry trail, leash required — boots recommended',
    ...
    spots: [
      {
        ...
        dogFriendly: false,
        seclusionScore: 'Moderate',
        dogFriendlyNote: 'Overgrown grassy bank, no formal trail',
        gaugeId: '05403500',
  ...
  // ═══════════════════════════════════════════════════════
  //  HIGH SECLUSION DISCOVERIES — Milwaukee & Juneau County
  // ═══════════════════════════════════════════════════════

  {
    id: 'grant-park-south-shore',
    name: 'Grant Park – South Shore Beach',
    region: 'Southeast',
    type: 'Lake Michigan Shore',
    dogFriendly: true,
    description: 'Milwaukee County park on Lake Michigan in Cudahy. The secluded north end of the beach requires a 0.5-mile trail through wooded bluffs — long enough to shake most weekend visitors. One of the most peaceful Lake Michigan shore-fishing spots in the metro area.',
    fish: ['Yellow Perch', 'Chinook Salmon', 'Steelhead', 'Coho Salmon'],
    spots: [
      {
        id: 40,
        name: 'Grant Park – Bluff Trail End (North Beach)',
        query: 'Grant Park South Shore Beach Milwaukee County Park Cudahy WI',
        fish: ['Yellow Perch', 'Chinook Salmon', 'Steelhead', 'Coho Salmon'],
        difficulty: 'Easy',
        accessPoint: 'Wooded bluff trail from South Lake Dr lot (~0.5 mi)',
        dogFriendly: true,
        seclusionScore: 'High',
        dogFriendlyNote: 'Sandy beach, leash required — dogs welcome year-round at this end',
        notes: 'Walk the wooded bluff trail north from the South Lake Drive parking area roughly 0.5 miles to reach the secluded north end of the beach. Dramatically less crowded than the main beach area. Shore cast for yellow perch with a small jig or worm under a bobber throughout summer and fall. Chinook salmon and steelhead move along this stretch in spring (Apr–May) and fall (Oct–Nov) — cast spoons or spawn sacks from the rocky points between sand sections. Dogs on leash are welcome at this end of the beach. State park vehicle sticker or day pass required at the main lot.',
        coords: { lat: 42.8795, lng: -87.8450 },
      },
    ],
  },

  {
    id: 'whitnall-root-river-bend',
    name: 'Whitnall Park – Root River Woodland Bend',
    region: 'Southeast',
    type: 'River',
    dogFriendly: true,
    description: 'Milwaukee County\'s largest park in Greenfield. The Root River runs through the southern section of the park. The secluded river bend accessed via the woodland trail — about 0.4 miles from the main lot — receives almost no fishing pressure despite being a productive smallmouth and steelhead spot.',
    fish: ['Smallmouth Bass', 'Steelhead', 'Brown Trout', 'Channel Catfish'],
    spots: [
      {
        id: 41,
        name: 'Whitnall Park – Root River Woodland Access',
        query: 'Whitnall Park Root River Greenfield WI Milwaukee County',
        fish: ['Smallmouth Bass', 'Steelhead', 'Brown Trout', 'Channel Catfish'],
        difficulty: 'Easy',
        accessPoint: 'Woodland trail from main lot (~0.4 mi) – free',
        dogFriendly: true,
        seclusionScore: 'High',
        dogFriendlyNote: 'Packed-dirt woodland trail, leash required — excellent dog walk',
        gaugeId: '04087000',
        notes: 'From the main Whitnall Park lot off 92nd St, follow the woodland trail south along the Root River approximately 0.4 miles to reach a secluded river bend with excellent structure — undercut banks, fallen logs, and a deep outside-of-bend pool. Smallmouth bass are the main draw from June through September; tube baits and small crayfish patterns work well in the current seams. Spring steelhead pass through in March–April — use spawn sacks or small spoons in the deep pool below the bend. Channel catfish on cut bait after dark in summer. Resident brown trout in cooler months. Check the Milwaukee River USGS gauge (04087000) — this tributary reflects similar conditions. Dogs on leash welcome throughout the park trail system.',
        coords: { lat: 42.9365, lng: -88.0355 },
      },
    ],
  },

  {
    id: 'lemonweir-bear-bluff',
    name: 'Lemonweir River – Bear Bluff Bend',
    region: 'South Central',
    type: 'River',
    dogFriendly: false,
    description: 'Remote Lemonweir River access in Juneau County near Necedah. A DNR public fishing easement with minimal roadside parking and a 0.35-mile walk along the river bank to reach the prime bend. Near-zero competition from other anglers — this stretch of the Lemonweir is genuinely off the radar.',
    fish: ['Walleye', 'Smallmouth Bass', 'Channel Catfish', 'Northern Pike'],
    spots: [
      {
        id: 42,
        name: 'Lemonweir River – Bear Bluff DNR Access',
        query: 'Lemonweir River public fishing access Necedah Juneau County WI',
        fish: ['Walleye', 'Smallmouth Bass', 'Channel Catfish', 'Northern Pike'],
        difficulty: 'Intermediate',
        accessPoint: 'DNR bank easement, roadside pulloff (~0.35 mi walk upstream)',
        dogFriendly: false,
        seclusionScore: 'High',
        dogFriendlyNote: 'Overgrown riverbank, no formal trail — not suitable for dogs',
        gaugeId: '05403500',
        notes: 'One of the most overlooked stretches of the Lemonweir in Juneau County. Park at the roadside DNR easement marker near Necedah and walk 0.35 miles upstream along the bank to reach a pronounced river bend with a deep outside pool — prime walleye and smallmouth habitat. Walleye bite best at dawn and dusk in the pool below the bend; jig with a 1/8 oz lead-head in natural colors. Smallmouth bass throughout the gravel runs using tubes or crayfish imitations. Channel catfish on cut bait from the bank on summer evenings. Northern pike patrol the slower upstream slackwater. Check the USGS Lemonweir gauge (05403500) before making the drive — after heavy rain the river colors up significantly and fishing drops off sharply for 2–3 days. This spot earns its seclusion score — the walk and overgrown bank keep casual anglers away.',
        coords: { lat: 43.8920, lng: -90.1360 },
      },
    ],
  },
